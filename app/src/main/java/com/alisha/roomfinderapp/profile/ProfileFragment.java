package com.alisha.roomfinderapp.profile;
...
public class ProfileFragment extends Fragment implements View.OnClickListener{
    ...
    @SuppressLint("RestrictedApi") final FirebaseHelper firebaseHelper = new FirebaseHelper(AuthUI.getApplicationContext());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference ref = db.getReference(FilePaths.USER);
//        DatabaseReference userRatingRef = ref.child(user.getUid()).child(FP.ra);
